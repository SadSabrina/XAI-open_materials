...
PREFIX = "batch_artifact" #"batch_artifact", "baseline"
...
- Use model_performance, sanity_checks, feature_importance, shap_explanation, and explain_single_prediction.
- After collecting tool outputs, immediately write the final report.
...
""",
            ...
            "messages": [
                {
                    ...
                    Analyze the trained model.
                                    ...
                                    5. Local explanation for row_index=7
                                    6. Limitations
    ...
    path = write_report(f"02_naive_agent_report_{PREFIX}.md", final)
    print(final)
